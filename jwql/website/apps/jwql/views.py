...
from .data_containers import webpage_template_data, miri_data_trending, nirspec_data_trending
...
def nirspec_data_trending(request):
    ...
    variables, dash = nirspec_data_trending()
...
def miri_data_trending(request):
    ...
    variables, dash = miri_data_trending()
